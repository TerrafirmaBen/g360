...
function swap_active_layers(layer_a_id, layer_b_id) {
  if (layer_a_id > 0 & layer_b_id > 0) {console.log("First layer selected:", layer_a_id, activeLayers[layer_a_id]);
  console.log("Second layer selected:", layer_b_id, activeLayers[layer_b_id]);
